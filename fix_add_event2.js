...
c = c.replace('id="recurrence-end-date"', 'id="recurrence-end-date" value="<%= typeof event !== \'undefined\' && event && event.recurrence_end_date ? event.recurrence_end_date : \'\' %>"');

const createBtnLine = 'Create Event\\n        </button>';
c = c.replace(createBtnLine, '<%= typeof event !== \'undefined\' && event ? \'Update Event\' : \'Create Event\' %>\\n        </button>');
