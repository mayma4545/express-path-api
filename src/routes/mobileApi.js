...
router.post('/admin/nodes/create', requireAuth, async (req, res) => {
    try {
        const { name, building, floor_level, type_of_node, description, map_x, map_y, image360_base64 } = req.body;

        // node_code is auto-generated by NodeService when not supplied
        const node = await NodeService.createNode(
            { name, building, floor_level, type_of_node, description, map_x, map_y },
